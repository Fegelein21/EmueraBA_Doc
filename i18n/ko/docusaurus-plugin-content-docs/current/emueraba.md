...
; "에너지 드링크"의 인덱스 값은 1로 할당됩니다.
1,에너지 드링크
; "술"의 인덱스 값은 자동으로 0으로 할당됩니다. 왜냐하면 인덱스 0이 사용되지 않았기 때문입니다.
,술
; "Wine"의 인덱스 값은 "술"을 참조하므로 0입니다.
술,Wine
; "ジュース"의 인덱스 값은 나중의 "과일 주스"를 참조하므로 2입니다.
과일 주스,ジュース
; "과일 주스"의 인덱스 값은 자동으로 2로 할당됩니다. 왜냐하면 인덱스 0과 1이 이미 사용되었기 때문입니다.
,과일 주스
```
